! function() {
    for (var t, i = function() {}, s = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], e = s.length, n = window.console = window.console || {}; e--;) t = s[e], n[t] || (n[t] = i)
}(),
function(t, i) {
    "use strict";
    var s, e = t.document,
    ...
    i.Isotope.settings = {
        ...
        _create: function(t) {
            ...
            }, 0), this.options.resizable && A.bind("smartresize.isotope", function() {
                h.resize()
        ...
        destroy: function() {
            ...
            this.element.unbind(".isotope").undelegate("." + i.hiddenClass, "click").removeClass(i.containerClass).removeData("isotope"), A.unbind(".isotope")
        },
